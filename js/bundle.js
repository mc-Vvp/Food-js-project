...
function cards() {
  ...
  (0,_services_services__WEBPACK_IMPORTED_MODULE_5__.getResources)("http://localhost:3000/menu").then(function (data) {
...
function forms(formSelector, modalTimer) {
  ...
  function showThanksModal(message) {
    ...
    (0,_modal__WEBPACK_IMPORTED_MODULE_9__.openModal)(".modal", modalTimer);
...
function openModal(modalSelector, modalTimer) {
  ...
  modal.classList.add("fadepoup"); //modal.style.display = "block"; anothe rway
...
function closeModal(modalSelector) {
  var modal = document.querySelector(modalSelector); //modal.style.display = "none"; another way
...
function modal(triggerSelector, modalSelector, modalTimer) {
  // MODAL
  var modalShow = document.querySelectorAll(triggerSelector),
      modal = document.querySelector(modalSelector);
  modalShow.forEach(function (btn) {
    btn.addEventListener("click", function () {
      return openModal(modalSelector, modalTimer);
    }); // arrow function used to prevent function from calling itself
  });
...
/* harmony import */ var _timer__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./timer */ "./js/modules/timer.js");
...
function slider(_ref) {
  ...
  function updateSLideNum(i) {
    currentSlideNum.textContent = (0,_timer__WEBPACK_IMPORTED_MODULE_5__.getZero)(i);
  }

  totalSlidesNum.textContent = (0,_timer__WEBPACK_IMPORTED_MODULE_5__.getZero)(slides.length);
  updateSLideNum(slidenum);
  dots.forEach(function (dot) {
...
function tabs(tabsSelector, tabsContentSelector, tabsParenSelector, activeClass) {
  ...
  function showTabContent() {
    ...
    // assighn default value to argument in function
  ...
  tabsParent.addEventListener("click", function (event) {
    ...
    if (target && target.classList.contains(tabsSelector.slice(1))) {
      // make sure that only sons are clickable and not parent
...
function timer(id, deadLine) {
  ...
  function setClock(selector, endtime) {
    ...
    function updateClock() {
      var remainTime = getTimeRemainig(endtime);
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_4__["default"])(".timer", "2022-09-22 00:00");
  (0,_modules_cards__WEBPACK_IMPORTED_MODULE_5__["default"])();
  (0,_modules_calculator__WEBPACK_IMPORTED_MODULE_6__["default"])();
  (0,_modules_forms__WEBPACK_IMPORTED_MODULE_7__["default"])("form", modalTimer);
